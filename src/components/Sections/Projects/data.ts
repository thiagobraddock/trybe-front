...
export const PROJECTS_LIST = [
  ...
  {
    title: 'Password Manager ✨ 25 pontos',
    ...
    exercises: [
      { title: 'Solar System ', points: '✨ 4 pontos' },
      { title: 'React-form ', points: '✨ 3 pontos' },
    ],
  },
  {
    title: 'TrybeTunes ✨ 40 pontos ',
    image: tunes,
    ...
    exercises: [
      { title: 'Bloggers - React Router', points: '✨ 3 pontos' },
    ],
  },
  {
